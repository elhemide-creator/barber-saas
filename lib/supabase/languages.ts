export const languages = {
  ...
  en: {
    ...
    selectTime: "Choose an available time for today:",
    submitBtn: "Confirm Appointment",
    successTitle: "Booking Successful!",
    successDesc: "Your appointment has been recorded. You will be notified upon confirmation.",
  ...
  ru: {
    ...
    selectTime: "Выберите доступное время на сегодня:",
    submitBtn: "Подтвердить Запись",
    successTitle: "Запись Успешна!",
    successDesc: "Ваша запись зарегистрирована. Вы будете уведомлены после подтверждения.",
